...
CREATE TABLE [Couples] (
    ...
    CONSTRAINT [FK_Couples_Users_PartnerId] FOREIGN KEY ([PartnerId]) REFERENCES [Users] ([Id]) ON DELETE SET NULL
);
GO
...
CREATE TABLE [SIPs] (
    ...
    CONSTRAINT [FK_SIPs_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [Users] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [FuelEntries] (
    ...
    CONSTRAINT [FK_FuelEntries_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [Users] ([Id]) ON DELETE CASCADE,
